...
def background_correction(dataframe: pd.DataFrame, file_name, file_path):
...
def normalize_data(baseline_corrected):
    '''
    Normalize the time and intensity axes of the chromatograms obtained in bg_corr to 0,1 on the time axis
    '''
    normalized_data = baseline_corrected.copy()
